...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull TextView LoginTitle,
      @NonNull Button Mypage, @NonNull Button button2, @NonNull Button button3,
      @NonNull Button googleBtn, @NonNull ImageView imageView, @NonNull Button loginBtn,
      @NonNull EditText loginID, @NonNull EditText loginPw, @NonNull Button naverBtn,
      @NonNull Button signUpAtivityBtn, @NonNull Button testBtn) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, LoginTitle, Mypage, button2,
          button3, googleBtn, imageView, loginBtn, loginID, loginPw, naverBtn, signUpAtivityBtn,
          testBtn);
    }
